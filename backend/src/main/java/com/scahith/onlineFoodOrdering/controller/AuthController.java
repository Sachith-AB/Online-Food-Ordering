...
import com.scahith.onlineFoodOrdering.model.USER_ROLE;
...
import com.scahith.onlineFoodOrdering.request.LogingRequest;
import com.scahith.onlineFoodOrdering.response.AuthResponse;
import com.scahith.onlineFoodOrdering.service.CustomUserDetailsService;
...
public class AuthController {
    ...
    @PostMapping("/signin")
    public ResponseEntity<AuthResponse> signin(@RequestBody LogingRequest req) {
