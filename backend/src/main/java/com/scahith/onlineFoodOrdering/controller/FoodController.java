...
public class FoodController {
    ...
    public ResponseEntity<List<Food>> getResturantFood(@RequestParam boolean vegitarian, @RequestParam boolean seasonal,
    ...
    @GetMapping("/allFoods")
    public ResponseEntity<List<Food>> getAllFoods(@RequestHeader("Authorization") String token) throws Exception {
